...
def analyse_file(dataset):
    ...
    st.write("When file save completes some summary graphs of all cycles together will be shown and individual cycle graphs")
    # Iterate through the DataFrame and apply the condition 
...
def main():
    ...
    st.write("Example file to upload at https://github.com/Ddbol/DevAcProj_CobotOps/blob/main/streamlit_app_cobot/cobot_dataset_02052023.xlsx")
    ...
    if uploaded_file is not None:
        ...
        i = 2
        while i < 250:
            fignum_name = (f'Cycle_{i}.png')
            st.write(f"Temperature, Current and Speed graphs for cycle {i}")
            st.image(Image.open(fignum_name))
            i += 1            
